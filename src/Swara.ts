...
import { SwaraDefaults, VoiceState } from './Constants';
...
export interface SwaraOptions {
    ...
    userAgent?: string;
    /**
     * Custom structures for Swara to use
     */
...
export interface SwaraEvents {
    ...
    /**
     * Emitted when Swara is ready to receive operations
     * @eventProperty
     */
...
export declare interface Swara {
    on<K extends keyof SwaraEvents>(event: K, listener: (...args: SwaraEvents[K]) => void): this;
    once<K extends keyof SwaraEvents>(event: K, listener: (...args: SwaraEvents[K]) => void): this;
    off<K extends keyof SwaraEvents>(event: K, listener: (...args: SwaraEvents[K]) => void): this;
 ...
 * Main Swara class
 */
export class Swara extends EventEmitter {
    /**
     ...
     * Swara options
     */
    public readonly options: Required<SwaraOptions>;
    /**
     ...
     * @param options Options to pass to create this Swara instance
     ...
     * @param options.structures Custom structures for Swara to use
     * @param options.nodeResolver Used if you have custom lavalink node resolving
     */
    constructor(connector: Connector, nodes: NodeOption[], options: SwaraOptions = {}) {
        super();
        this.connector = connector.set(this);
        this.options = mergeDefault(SwaraDefaults, options);
        this.nodes = new Map();
     ...
     * @param options.version Rest version to use
     ...
     * @param args Additional arguments for Swara to emit
